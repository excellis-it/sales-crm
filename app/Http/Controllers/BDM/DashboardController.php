...
class DashboardController extends Controller
{
    ...
    {
        $count['projects'] = BdmProject::where('user_id', auth()->user()->id)->orderBy('created_at', 'desc')->count();
        $prospects = BdmProspect::where('report_to', auth()->user()->id)->orderBy('sale_date', 'desc')->paginate(15);
        $count['prospects'] = BdmProspect::where('report_to', auth()->user()->id)->count();
    ...
    public function bdmDashboardProspectSearch(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $prospects = BdmProspect::where('report_to', auth()->user()->id)
