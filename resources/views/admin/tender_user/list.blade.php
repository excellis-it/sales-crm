...
@section('title')
    All Tender User Details - {{ env('APP_NAME') }}
@endsection
@push('styles')
    <style>
        .dataTables_filter {
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Tender User Information</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('tender-users.index') }}">Tender User</a>
                            </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-0">Tender User Details</h4>
                            </div>
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="offcanvas-header">
                            ...
                            <h4 id="offcanvasEditLabel">Add Tender User Details</h4>
                        </div>
                        <div class="offcanvas-body">
                            <form action="{{ route('tender-users.store') }}" method="post" enctype="multipart/form-data"
                                id="tender-users-form-create">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="name"  class="form-control"
                                            value="{{ old('name') }}" placeholder="Enter Tender User Name">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="email"  class="form-control"
                                            value="{{ old('email') }}" placeholder="Enter Tender User Email">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit"
                        ...
                        <div class="offcanvas-header">
                            ...
                            <h4 id="offcanvasEditLabel">Edit Tender User Details</h4>
                        </div>
                        <div class="offcanvas-body">
                            <form action="" method="POST" enctype="multipart/form-data" id="tender-users-edit-form">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="inputEnterYourName" class="col-form-label"> Date Of Joining </label>
                                        <input type="date" name="date_of_joining"
                                            max="{{ date('Y-m-d') }}" class="form-control picker" id="date_of_joining"
                                            value="{{ old('date_of_joining') }}">
                    ...
                    <div class="table-responsive" id="tender_users_data">
                        @include('admin.tender_user.table')
...
@push('scripts')
            ...
            $('#search').on('keyup', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#tender_users_data').html(response.view);
    ...
    <script>
        $(document).on('click', '#delete', function(e) {
            swal({
                    title: "Are you sure?",
                    text: "To delete this tender_user.",
                    type: "warning",
    ...
    <script>
        $(document).on('change', '.toggle-class', function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('tender-users.change-status') }}',
                data: {
                    'status': status,
                    'user_id': user_id
                },
    ...
    <script>
        $(document).ready(function() {
            $('#tender-users-form-create').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success('Tender User Added Successfully');
                    },
                    error: function(xhr) {
        ...
        $(document).ready(function() {
            $(document).on('click', '.edit-route', function() {
                ...
                $.ajax({
                    ...
                    type: 'GET',
                    success: function(response) {
                        var tender_user = response.tender_user;

                        $('#name').val(tender_user.name);
                        $('#employee_id').val(tender_user.employee_id);
                        $('#date_of_joining').val(tender_user.date_of_joining);
                        $('#email').val(tender_user.email);
                        $('#phone').val(tender_user.phone);
                        $('#status').val(tender_user.status);
                        var updateRoute =
                            "{{ route('tender-users.update', ['tender_user' => ':id']) }}";
                        updateRoute = updateRoute.replace(':id', tender_user.id);
                        $('#tender-users-edit-form').attr('action', updateRoute);
                        $('#loading').removeClass('loading');
                        $('#loading-content').removeClass('loading-content');
            ...
            $('#tender-users-edit-form').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        window.location.reload();
                        toastr.success('Tender User details updated successfully');
                    },
                    error: function(xhr) {
                        // Handle errors (e.g., display validation errors)
                        var errors = xhr.responseJSON.errors;
