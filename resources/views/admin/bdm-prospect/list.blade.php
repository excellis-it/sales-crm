                ...
                <div class="card-body">
                    ...
                    <div class="card-title">
                        <div class="row filter-gap align-items-center">
                            <div class="col">
                                <a href="javascript:void(0);" data-value="All" class="desin-filter {{ (!isset($status_filter) || !$status_filter || $status_filter == 'All') ? 'active-filter' : '' }}">
                                    <p>All</p>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="offcanvas-body">
                                <form action="{{ route('admin.bdm-prospects.store') }}" method="post" data-parsley-validate=""
