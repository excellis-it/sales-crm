...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('admin.tender-projects.store') }}" method="POST" id="tender_project_form">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="form-section-title mt-4"><i class="fas fa-address-book"></i> Contact & Assignment</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status == 422) {
                        ...
                        $.each(errors, function(key, value) {
                            // Map dotted keys like milestones.0.milestone_name to something or just general fields
                            var errorKey = key.replace(/\./g, '_');
                            $('.' + errorKey + '_error').html(value[0]);
                            // Also try a generic toastr for array errors
                            if(key.includes('.')){
