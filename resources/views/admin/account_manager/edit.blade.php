...
@section('title')
    {{ env('APP_NAME') }} | Edit Account manager Details
@endsection
@push('styles')
@endpush
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Account manager Details</li>
                        </ul>
                    </div>
                    ...
                    <div class="card-title">
                        <div class="row">
                            <div class="col-xl-12 mx-auto">
                                <h6 class="mb-0 text-uppercase">Edit A Account manager</h6>
                                <hr>
                                <div class="border-0 border-4">
                                    <div class="card-body">
                                        <form action="{{ route('account_managers.update', $account_manager->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="name" id=""
                                                            class="form-control" value="{{ $account_manager['name'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="employee_id" id=""
                                                            class="form-control" value="{{ $account_manager['employee_id'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="date_of_joining picker" id="" max="{{ date('Y-m-d') }}"
                                                            class="form-control" value="{{ $account_manager['date_of_joining'] }}"
                                                            >
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="email" id=""
                                                            class="form-control" value="{{ $account_manager['email'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="phone" id=""
                                                            class="form-control" value="{{ $account_manager['phone'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="password" name="confirm_password" id=""
                                                            class="form-control"
                                                            value="{{ $account_manager['confirm_password'] }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="status" id="" class="form-control">
                                                            ...
                                                            <option value="1"
                                                                @if ($account_manager['status'] == 1) selected="" @endif>Active
                                                            </option>
                                                            <option value="0"
                                                                @if ($account_manager['status'] == 0) selected="" @endif>
                                                                Inactive</option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" name="profile_picture" id=""
                                                            class="form-control"
                                                            value="{{ $account_manager['profile_picture'] }}">
                                                        @if ($errors->has('profile_picture'))
                                                            <div class="error" style="color:red;">
                                                                {{ $errors->first('profile_picture') }}</div>
                                                        @endif
                                                    </div>
                                                    @if ($account_manager['profile_picture'])
                                                        <div class="col-md-6">
                                                            <label for="inputEnterYourName" class="col-form-label">View
                                                                Profile Picture </label>
                                                            <br>
                                                            <img src="{{ Storage::url($account_manager['profile_picture']) }}"
