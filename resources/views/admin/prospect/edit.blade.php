@if (isset($type))
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <form action="{{ route('admin.prospects.update', $prospect->id) }}" method="post" data-parsley-validate=""
                ...
                <div class="row">
                    ...
                    <div id="followup_date_div" style="display: {{ $prospect->status == 'Follow Up' ? 'block' : 'none' }};">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" name="followup_date" id="followup_date" {{ $prospect->status == 'Follow Up' ? 'required' : '' }} class="form-control"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="time" name="followup_time" id="followup_time" {{ $prospect->status == 'Follow Up' ? 'required' : '' }} class="form-control"
