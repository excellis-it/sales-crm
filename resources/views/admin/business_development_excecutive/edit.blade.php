            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('business-development-excecutive.index') }}">Sales excecutives</a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 mx-auto">
                                ...
                                <div class="border-0 border-4">
                                    <div class="card-body">
                                        <form action="{{ route('business-development-excecutive.update', $business_development_excecutive->id) }}"
                                                        ...
                                                        <select name="bdm_id" id=""
                                                            ...
                                                            @foreach ($business_development_managers as $business_development_manager)
                                                                <option value="{{ $business_development_manager->id }}"
                                                                    {{ $business_development_manager->id == $business_development_excecutive->bdm_id ? 'selected' : '' }}>
                                                                    {{ $business_development_manager->name }} ({{  $business_development_manager->email }})</option>
                                                            @endforeach
                                                        </select>
                                                        @if ($errors->has('bdm_id'))
                                                            <div class="error" style="color:red;">
                                                                {{ $errors->first('bdm_id') }}</div>
                                                        @endif
                                                    </div>
                                                    <div class="col-md-6">
