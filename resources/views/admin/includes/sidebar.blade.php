    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="sidebar-vertical">
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/prospects*') || Request::is('admin/sales-projects*') ? 'active' : '' }}"><i class="la la-book-open"></i> <span> Telecaller Pipeline </span> <span class="menu-arrow"></span></a>
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/bdm-prospects*') || Request::is('admin/bdm-projects*') ? 'active' : '' }}"><i class="la la-rocket"></i> <span> BDM Pipeline </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/tender-users*') || Request::is('admin/tender-projects*') || Request::is('admin/tender-statuses*') ? 'active' : '' }}"><i class="la la-user-tag"></i> <span> Tender Management </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                ...
                <li class="{{ Request::is('admin/goals*') ? 'active' : '' }}">
                    <a href="{{ route('goals.index') }}"><i class="la la-bullseye"></i> <span> Users Goals </span></a>
                </li>
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/sales_managers*') || Request::is('admin/account_managers*') || Request::is('admin/sales-excecutive*') ? 'active' : '' }}"><i class="la la-users"></i> <span> Telecaller Team </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/business-development-managers*') || Request::is('admin/business-development-excecutive*') ? 'active' : '' }}"><i class="la la-briefcase"></i> <span> BD Team </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                ...
                <li class="menu-title">
                 ...
                 <li class="submenu">
                    <a href="#" class="{{ Request::is('admin/profile*') || Request::is('admin/password*') || Request::is('admin/detail*') ? 'active' : '' }}"><i class="la la-user-cog"></i> <span>Manage Account </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
