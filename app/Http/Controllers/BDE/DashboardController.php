...
class DashboardController extends Controller
{
    ...
    {
        $count['prospects'] = BdmProspect::where('user_id', auth()->user()->id)->count();
        ...
        $goal['prospect_march'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 3)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_april'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 4)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_may'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 5)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_june'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 6)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_july'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 7)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_august'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 8)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_september'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 9)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_october'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 10)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_november'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 11)->whereYear('sale_date', date('Y'))->count();
        $goal['prospect_december'] = BdmProspect::where('user_id', auth()->user()->id)->whereMonth('sale_date', 12)->whereYear('sale_date', date('Y'))->count();
        $prospects = BdmProspect::where('user_id', auth()->user()->id)->orderBy('sale_date', 'desc')->paginate(15);
