                             ...
                             <div class="mt-2 d-flex flex-wrap gap-2">
                                 @if ($followup->meeting_date)
                                     <span
                                         ...
                                         <i class="fas fa-handshake me-1"></i> Meeting:
                                         {{ \Carbon\Carbon::parse($followup->meeting_date)->format('d M Y') }}
                                     </span>
                                 @endif
                                 @if ($followup->next_followup_date)
                                     <span
                                         style="font-size: 11px; color: #fd7e14; background: #fff4e6; padding: 2px 8px; border-radius: 4px;">
                                         <i class="far fa-calendar-alt me-1"></i> Next Follow-up:
