                    ...
                    <div class="stats-card-one mb-30">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fs-25"> {{ $goal['gross_goals'] ? '$' . $goal['gross_goals'] : 'N/A' }} /
                    ...
                    <div class="stats-card-one mb-30">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fs-25"> {{ $goal['net_goals'] ? '$' . $goal['net_goals'] : 'N/A' }} /
                    ...
                    <div class="stats-card-one mb-30">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fs-25"> {{ $count['sales_excecutive'] }} </h3>
                            </div>
                    ...
                    <div class="stats-card-one mb-30">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fs-25">{{ $count['account_managers'] }}</h3>
                            </div>
                        ...
                        <div class="mt-15">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="fw-600">{{ $count['users'] }}</span>
                            </div>
