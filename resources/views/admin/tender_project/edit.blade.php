...
<style>
    ...
    .btn-add-ms { background: #343a40; color: #fff; border-radius: 30px; padding: 5px 20px; border: none; font-size: 12px; }
...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.tender-projects.index') }}">Tender Projects</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('admin.tender-projects.update', $tender->id) }}" method="POST" id="edit_tender_project_form">
                        @csrf
                        @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tender_name" class="form-control" value="{{ $tender->tender_name }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tender_id_ref_no" class="form-control" value="{{ $tender->tender_id_ref_no }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="department_org" class="form-control" value="{{ $tender->department_org }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="category" id="category_select" class="form-control select2">
                                                ...
                                                <option value="Hardware" {{ $tender->category == 'Hardware' ? 'selected' : '' }}>Hardware</option>
                                                <option value="AMC" {{ $tender->category == 'AMC' ? 'selected' : '' }}>AMC</option>
                                                <option value="Software" {{ $tender->category == 'Software' ? 'selected' : '' }}>Software</option>
                                            </select>
                                            <span class="text-danger category_error"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3" id="category_title_div" style="{{ $tender->category ? '' : 'display:none;' }}">
                                        <div class="form-group">
                                            <label>Category Title <span class="text-danger">*</span></label>
                                            <input type="text" name="category_title" class="form-control" value="{{ $tender->category_title }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" name="tender_value_lakhs" class="form-control" value="{{ $tender->tender_value_lakhs }}">
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>EMD</label>
                                            <input type="text" name="emd" class="form-control" value="{{ $tender->emd }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="delivery_date" class="form-control" value="{{ $tender->delivery_date }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control select2">
                                                @foreach($statuses as $status)
                                                    <option value="{{ $status->id }}" {{ $tender->status == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="l1_quoted_value" class="form-control" value="{{ $tender->l1_quoted_value }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="excellis_it_quoted_price" class="form-control" value="{{ $tender->excellis_it_quoted_price }}">
                                            <span class="text-danger excellis_it_quoted_price_error"></span>
                                        </div>
                                    </div>
                                </div>

                                <h4 class="form-section-title mt-4"><i class="fas fa-user-shield"></i> Ownership & Contacts</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Contact Name</label>
                                            <input type="text" name="contact_authority_name" class="form-control" value="{{ $tender->contact_authority_name }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact_authority_phone" class="form-control" value="{{ $tender->contact_authority_phone }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="contact_authority_email" class="form-control" value="{{ $tender->contact_authority_email }}">
                                            <span class="text-danger contact_authority_email_error"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Assign Tender Manager <span class="text-danger">*</span></label>
                                            <select name="tender_user_id" class="form-control select2">
                                                @foreach($tender_users as $user)
                                                    <option value="{{ $user->id }}" {{ $tender->tender_user_id == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger tender_user_id_error"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4 class="form-section-title mt-4 d-flex justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-add-ms" id="add_milestone_btn"><i class="fas fa-plus"></i> Add Milestone</button>
                                </h4>
                                    ...
                                    <table class="table milestone-table" id="milestones_table">
                                        ...
                                        <tbody>
                                            @foreach($tender->milestones as $key => $milestone)
                                                <tr>
                                                    <td><input type="text" name="milestones[{{ $key }}][milestone_name]" class="form-control" value="{{ $milestone->milestone_name }}"></td>
                                                    <td><input type="text" name="milestones[{{ $key }}][milestone_value]" class="form-control" value="{{ $milestone->milestone_value }}"></td>
                                                    <td>
                                                        <select name="milestones[{{ $key }}][payment_status]" class="form-control">
                                                    ...
                                                    <td><input type="date" name="milestones[{{ $key }}][payment_date]" class="form-control" value="{{ $milestone->payment_date }}"></td>
                                                    <td><textarea name="milestones[{{ $key }}][milestone_comment]" class="form-control" rows="1">{{ $milestone->milestone_comment }}</textarea></td>
                                                    <td><select name="milestones[{{ $key }}][payment_mode]" class="form-control">
                                ...
                                <div class="submit-section mt-5 text-end">
                                    ...
                                    <a href="{{ route('admin.tender-projects.index') }}" class="btn btn-cancel">Back</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    $(document).ready(function() {
        ...
        $('#add_milestone_btn').click(function() {
            var html = `<tr>
                ...
                <td><select name="milestones[${msCount}][payment_mode]" class="form-control">
                                            <option value="">Select Mode</option>
                                            <option value="Paypal">Paypal</option>
                                            <option value="Stripe">Stripe</option>
                                          <option value="Bank Transfer">Bank Transfer</option>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "{{ route('admin.tender-projects.index') }}";
                        }, 1000);
                    }
                },
                error: function(xhr) {
