            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('sales-manager.ips.index') }}">IP</a>
                            </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="offcanvas-body">
                                <form action="{{ route('sales-manager.ips.store') }}" method="post"
                                    enctype="multipart/form-data" id="ip-form-create">
                                    @csrf
                                    <div class="row">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit"
                            ...
                            <div class="offcanvas-body">
                                <form action="" method="POST" enctype="multipart/form-data" id="ip-edit-form">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                    ...
                    <div class="table-responsive" id="ip_data">
                        @include('sales_manager.ip.table')
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#search').on('keyup', function() {
                var text = $('#search').val();
                url = "{{ route('sales-manager.ips.search') }}"
                ...
                $(document).on('click', '.edit-route', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var updateRoute =
                                "{{ route('sales-manager.ips.update', ['ip' => ':id']) }}";
