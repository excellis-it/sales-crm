...
class TransferTakenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('bde.transfer-taken.list')->with(compact('prospects','total_prospect'));
    }
    ...
    public function show($id)
    {
        try {
            ...
            $isThat = 'view';
            return response()->json(['view' => (string)View::make('bde.transfer-taken.show-details')->with(compact('prospect', 'isThat'))]);
        } catch (\Throwable $th) {
    ...
    public function transferTakenFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return response()->json(['data' => view('bde.transfer-taken.table', compact('prospects'))->render()]);
        }
    }
}
