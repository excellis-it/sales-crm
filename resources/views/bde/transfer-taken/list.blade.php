        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="show-details">
                    @include('bde.transfer-taken.show-details')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('bde.transfer-taken.index') }}">Prospects</a>
                            </li>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="show-transfer-taken">
                        <table id="myTable" class="dd table table-striped table-hover"
                            ...
                            <tbody>
                                @include('bde.transfer-taken.table')
                            </tbody>
                        </table>
    ...
    <script>
        $(document).ready(function() {
            function fetch_data(page, query) {
                ...
                $.ajax({
                    url: "{{ route('bde.transfer-taken.filter') }}",
                    data: {
                        user_id: user_id,
                        page: page,
                        query: query
