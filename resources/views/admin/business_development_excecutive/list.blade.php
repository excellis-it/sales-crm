                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('business-development-excecutive.index') }}">BDE</a></li>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#business-development-excecutive-form-create').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success('Business Development Excecutive Added Successfully');
                    },
                    error: function(xhr) {
    ...
    @if (count($business_development_excecutives) > 0)
        <script>
            $(document).ready(function() {
                ...
                $('#business-development-excecutive-edit-form').submit(function(e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            window.location.reload();
                            toastr.success('BDM details updated successfully');
                        },
                        error: function(xhr) {
                            // Handle errors (e.g., display validation errors)
                            var errors = xhr.responseJSON.errors;
