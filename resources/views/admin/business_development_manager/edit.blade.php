                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit BDM Details</li>
                        </ul>
                    </div>
                    <div class="col-auto float-end ms-auto">
                        {{-- <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_group"><i
                            class="fa fa-plus"></i> Add BDM</a> --}}
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-title">
                        <div class="row">
                            <div class="col-xl-12 mx-auto">
                                <h6 class="mb-0 text-uppercase">Edit A BDM</h6>
                                <hr>
                                <div class="border-0 border-4">
                                    <div class="card-body">
                                        <form action="{{ route('business-development-managers.update', $business_development_manager->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="name" id=""
                                                            class="form-control" value="{{ $business_development_manager['name'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="employee_id" id=""
                                                            class="form-control" value="{{ $business_development_manager['employee_id'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="date_of_joining" id="" max="{{ date('Y-m-d') }}"
                                                            class="form-control picker" value="{{ $business_development_manager['date_of_joining'] }}"
                                                            >
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="email" id=""
                                                            class="form-control" value="{{ $business_development_manager['email'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="phone" id=""
                                                            class="form-control" value="{{ $business_development_manager['phone'] }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="password" name="confirm_password" id=""
                                                            class="form-control"
                                                            value="{{ $business_development_manager['confirm_password'] }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="status" id="" class="form-control">
                                                            ...
                                                            <option value="1"
                                                                @if ($business_development_manager['status'] == 1) selected="" @endif>Active
                                                            </option>
                                                            <option value="0"
                                                                @if ($business_development_manager['status'] == 0) selected="" @endif>
                                                                Inactive</option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" name="profile_picture" id=""
                                                            class="form-control"
                                                            value="{{ $business_development_manager['profile_picture'] }}">
                                                        @if ($errors->has('profile_picture'))
                                                            <div class="error" style="color:red;">
                                                                {{ $errors->first('profile_picture') }}</div>
                                                        @endif
                                                    </div>
                                                    @if ($business_development_manager['profile_picture'])
                                                        <div class="col-md-6">
                                                            <label for="inputEnterYourName" class="col-form-label">View
                                                                Profile Picture </label>
                                                            <br>
                                                            <img src="{{ Storage::url($business_development_manager['profile_picture']) }}"
