                                            ...
                                            <div class="border p-4 rounded">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="bdm_id" id="" class="form-control select2">
                                                            <option value="">Select report to</option>
                                                            @foreach($business_development_managers as $business_development_manager)
                                                            <option value="{{ $business_development_manager->id }}">  {{ $business_development_manager->name }} ({{  $business_development_manager->email }})</option>
                                                            @endforeach
                                                        </select>
