...
class IpController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sales_manager.ip.list', compact('ip'));
    }
    ...
    public function delete($id)
    {
        ...
        $user->delete();
        return redirect()->route('sales-manager.ips.index')->with('error', 'Ip has been deleted successfully.');
    }
    ...
    public function search(Request $request)
    {
        if ($request->ajax()) {
            ...
            return response()->json(['view' => (string)View::make('sales_manager.ip.table')->with(compact('ip'))]);
        }
    }
}
