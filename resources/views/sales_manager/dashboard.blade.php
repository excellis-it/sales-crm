    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Welcome To Sales Manager Panel!</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="card dash-widget">
                            <div class="card-body">
                                ...
                                <div class="dash-widget-info">
                                    <h3>${{ $data['gross_target_this_month'] ?? 0 }}</h3>
                                    <span>Gross Target This Month</span>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="card dash-widget">
                            <div class="card-body">
                                <span class="dash-widget-icon"><i class="fas fa-dollar"></i></span>
                                <div class="dash-widget-info">
                                    <h3>${{ $data['net_target_this_month'] ?? 0 }}</h3>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="card dash-widget">
                            <div class="card-body">
                                <span class="dash-widget-icon"><i class="fas fa-dollar"></i></span>
                                <div class="dash-widget-info">
                                    <h3>${{ $data['gross_achieve_this_month'] ?? 0 }}</h3>
                                    <span>Achieve Gross Target This Month</span>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="card dash-widget">
                            <div class="card-body">
                                <span class="dash-widget-icon"><i class="fas fa-dollar"></i></span>
                                <div class="dash-widget-info">
                                    <h3>${{ $data['net_achieve_this_month'] ?? 0 }}</h3>
                                    <span>Achieve Net Target This Month</span>
                                </div>
                            </div>
                        </div>
                </div>
