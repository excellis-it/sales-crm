                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="offcanvas-body">
                                <form action="{{ route('business-development-managers.store') }}" method="post"
                                    enctype="multipart/form-data" id="business-development-managers-form-create">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ old('name') }}"
                                                placeholder="Enter Business Development Manager Name">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" name="email" class="form-control"
                                                value="{{ old('email') }}"
                                                placeholder="Enter Business Development Manager Email">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit"
                            ...
                            <div class="offcanvas-body">
                                <form action="" method="POST" enctype="multipart/form-data"
                                    id="business-development-managers-edit-form">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
            ...
            $(document).ready(function() {
                $(document).on('click', '.edit-route', function() {
                    ...
                    $.ajax({
                        ...
                        type: 'GET',
                        success: function(response) {
                            var business_development_manager = response
                            ...
                            updateRoute = updateRoute.replace(':id', business_development_manager
                                .id);
                            $('#business-development-managers-edit-form').attr('action',
                                updateRoute);
                            $('#loading').removeClass('loading');
                            $('#loading-content').removeClass('loading-content');
                ...
                $('#business-development-managers-edit-form').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            window.location.reload();
                            toastr.success(
                                'Business Development Manager details updated successfully');
                        },
                        error: function(xhr) {
                            // Handle errors (e.g., display validation errors)
                            var errors = xhr.responseJSON.errors;
