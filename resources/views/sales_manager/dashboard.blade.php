                ...
                <div class="stats-card-one mb-30">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fs-25"> {{ ($goal['gross_goals']['goals_amount']) ? '$'.$goal['gross_goals']['goals_amount'] : 'N/A'}} / ${{ $goal['gross_goals']['goals_achieve'] ?? 0}} </h3>
                        </div>
                        <?php
                    ...
                    <div class="mt-15">
                        ...
                        <div class="progress progress-sm mt-1">
                            <div class="progress-bar bg-primary" style="width: {{ $percentage['gross_goals'] ?? 0 }}%">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card-one mb-30">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fs-25"> {{ ($goal['net_goals']['goals_amount']) ? '$'.$goal['net_goals']['goals_amount'] : 'N/A'}} / ${{ $goal['net_goals']['goals_achieve'] ?? 0 }} </h3>
                        </div>
                        <?php
                    ...
                    <div class="mt-15">
                        ...
                        <div class="progress progress-sm mt-1">
                            <div class="progress-bar bg-danger" style="width: {{ $percentage['net_goals'] ?? 0 }}%">
                            </div>
                        </div>
                    </div>
                </div>
