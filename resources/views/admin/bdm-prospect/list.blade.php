...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="show-details">
                    @include('admin.bdm-prospect.show-details')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="{{ route('admin.bdm-prospects.sample-download') }}" class="btn btn-info btn-sm"><i
                                        class="fa fa-download"></i> Sample CSV</a>
                                <button type="button" data-bs-toggle="modal" data-bs-target="#importModal"
                                    class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> Import</button>
                    ...
                    <div id="edit-prospect-model">
                        @include('admin.bdm-prospect.edit')
                    </div>
                </div>
                <div class="table-responsive" id="show-prospect">
                    ...
                    <table id="myTable" class="dd table table-striped  table-hover" style="width:100%">
                        ...
                        <tbody id="prospect-body">
                            @include('admin.bdm-prospect.table')
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Import Prospects From CSV</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('admin.bdm-prospects.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info py-2">
                            <p class="mb-1 small"><strong>Required Columns:</strong></p>
                            <ul class="mb-0 small">
                                <li>client_name</li>
                                <li>designation</li>
                                <li>client_phone</li>
                            ...
                            <p class="mt-2 mb-0 small">Optional: client_email, website, price_quote, source, offered_for,
                                status, followup_date, followup_time, sales_manager_email</p>
                        </div>
                        <p class="text-muted small">Use the <a
                                href="{{ route('admin.bdm-prospects.sample-download') }}">Sample CSV</a> to ensure correct
                            format.</p>
                        <div class="alert alert-warning py-1 small mb-0">
                            <i class="fa fa-exclamation-triangle"></i> <strong>Note:</strong> If you use Excel, please
                            "Save As" <strong>CSV (Comma delimited)</strong> before uploading.
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, status, query, followup_date) {
                ...
                $.ajax({
                    url: "{{ route('admin.bdm-prospects.filter') }}",
                    data: {
                        status: status,
                        page: page,
                        query: query,
