                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="offcanvas-body">
                                <form action="{{ route('bde.store') }}" method="post" enctype="multipart/form-data"
                                    id="bde-form-create">
                                    @csrf
                                    <div class="row">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit"
                            ...
                            <div class="offcanvas-body">
                                <form action="" method="POST" enctype="multipart/form-data" id="bde-edit-form">
                                    @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#bde-form-create').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        toastr.success('BDE details added successfully');
                    },
                    error: function(xhr) {
            ...
            $(document).ready(function() {
                $(document).on('click', '.edit-route', function() {
                    ...
                    $.ajax({
                        ...
                        type: 'GET',
                        success: function(response) {
                            var bde = response.bde;
                            $('#name').val(bde.name);
                            $('#employee_id').val(bde.employee_id);
                            $('#date_of_joining').val(bde.date_of_joining);
                            $('#email').val(bde.email);
                            $('#phone').val(bde.phone);
                            $('#status').val(bde.status);
                            var updateRoute =
                                "{{ route('bde.update', ['bde' => ':id']) }}";
                            updateRoute = updateRoute.replace(':id', bde.id);
                            $('#bde-edit-form').attr('action', updateRoute);
                            $('#loading').removeClass('loading');
                            $('#loading-content').removeClass('loading-content');
                ...
                $('#bde-edit-form').submit(function(e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            window.location.reload();
                            toastr.success('BDE details updated successfully');
                        },
                        error: function(xhr) {
                            // Handle errors (e.g., display validation errors)
                            var errors = xhr.responseJSON.errors;
