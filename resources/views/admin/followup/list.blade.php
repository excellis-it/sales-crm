        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="show-details">
                    @include('admin.followup.show-details')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.followups.index') }}">Followups</a>
                            </li>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                ...
                $.ajax({
                    url: "{{ route('admin.followups.filter') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
