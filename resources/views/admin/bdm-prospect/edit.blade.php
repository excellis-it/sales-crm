...
<div class="col-md-12 mb-3">
                                <label for="inputEnterYourName"
                                    ...
                                    Date</label>
                                <input type="date" name="sale_date" id="sale_date" required data-parsley-trigger="keyup" data-parsley-type="date" data-parsley-type-message="Please enter a valid date."
                                    class="form-control"
