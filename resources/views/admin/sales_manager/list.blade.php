...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-header">
                            ...
                            <h4 id="offcanvasEditLabel">Add Sales managers Details</h4>
                        </div>
                        <div class="offcanvas-body">
                            <form action="{{ route('sales_managers.store') }}" method="post" enctype="multipart/form-data"
                                id="sales-manager-form-create">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="name"  class="form-control"
                                            value="{{ old('name') }}" placeholder="Enter Sales manager Name">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="email"  class="form-control"
                                            value="{{ old('email') }}" placeholder="Enter Sales manager Email">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit"
                        ...
                        <div class="offcanvas-body">
                            <form action="" method="POST" enctype="multipart/form-data" id="sales-manager-edit-form">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                    ...
                    <div class="table-responsive" id="sales_managers_data">
                        @include('admin.sales_manager.table')
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                $('#search').on('keyup', function() {
                    ...
                    url = "{{ route('sales_managers.search') }}"
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#sales_managers_data').html(response.view);
        ...
        <script>
            $(document).ready(function() {
                $('#sales-manager-form-create').submit(function(e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            toastr.success('Sales Manager details added successfully.');
                        },
                        error: function(xhr) {
            ...
            $(document).ready(function() {
                $(document).on('click', '.edit-route', function() {
                    ...
                    $.ajax({
                        ...
                        type: 'GET',
                        success: function(response) {
                            var sales_manager = response.sales_manager;

                            $('#name').val(sales_manager.name);
                            $('#employee_id').val(sales_manager.employee_id);
                            $('#date_of_joining').val(sales_manager.date_of_joining);
                            $('#email').val(sales_manager.email);
                            $('#phone').val(sales_manager.phone);
                            $('#status').val(sales_manager.status);
                            var updateRoute =
                                "{{ route('sales_managers.update', ['sales_manager' => ':id']) }}";
                            updateRoute = updateRoute.replace(':id', sales_manager.id);
                            $('#sales-manager-edit-form').attr('action', updateRoute);
                            $('#loading').removeClass('loading');
                            $('#loading-content').removeClass('loading-content');
                ...
                $('#sales-manager-edit-form').submit(function(e) {
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            window.location.reload();
                            toastr.success('Sales manager details updated successfully');
                        },
                        error: function(xhr) {
                            // Handle errors (e.g., display validation errors)
                            var errors = xhr.responseJSON.errors;
