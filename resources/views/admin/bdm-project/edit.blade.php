@if (isset($type))
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEdit" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <form action="{{ route('admin.bdm-projects.update', $project->id) }}" method="post" id="edit-form-validation"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Project Opener</label>
                        <select name="project_opener"  class="form-select select2-edit">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="comment" class="form-control" rows="2" readonly>{{ $project->comment }}</textarea>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach ($project->projectDocuments as $doc)
                                        <a href="{{ route('admin.bdm-projects.document.download', $doc->id) }}"
