                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sorting" data-tippy-content="Sort by Business Name" data-sorting_type="desc"
                                        data-column_name="business_name" style="cursor: pointer"> Business Name <span
                                    ...
                                    {{-- <th class="sorting" data-tippy-content="Sort by Customer Name" data-sorting_type="desc"
                                        data-column_name="customer_name" style="cursor: pointer"> Customer Name <span
                                            id="customer_name_icon"><span class="fa fa-sort-down"></span></span></th>
                                    <th class="sorting" data-tippy-content="Sort by Phone Number" data-sorting_type="desc"
                                        data-column_name="phone_number" style="cursor: pointer"> Phone Number <span
                                            id="phone_number_icon"><span class="fa fa-sort-down"></span></span></th> --}}
                                    ...
                                    <th class="sorting" data-tippy-content="Sort by Project value" data-sorting_type="desc"
                                        data-column_name="project_value" style="cursor: pointer"> Project Value <span
                                            id="project_value_icon"><span class="fa fa-sort-down"></span></span></th>
                                    <th class="sorting" data-tippy-content="Sort by Project Upfront"
                                        data-sorting_type="desc" data-column_name="project_upfront" style="cursor: pointer">
                                        Project Upfront <span id="project_upfront_icon"><span
                                    ...
                                    <th class="sorting" data-tippy-content="Sort by Payment Mode" data-sorting_type="desc"
                                        data-column_name="payment_mode" style="cursor: pointer"> Payment Mode <span
                                            id="payment_mode_icon"><span class="fa fa-sort-down"></span></span></th>
                                    ...
                                    <th data-tippy-content="Cant't sort by Due Amount" style="cursor: pointer"> Due Amount
                                        <span id="due_amount_icon"><span class="fa fa-sort-down"></span></span></th>
                                    <th> Action</th>
                                </tr>
                            </thead>
                            <tbody>
