            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('tender-user.tender-statuses.index') }}">Tender Status</a>
                            </li>
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="offcanvas-body">
                            <form action="{{ route('tender-user.tender-statuses.store') }}" method="post"
                    ...
                    <div class="table-responsive" id="tender_statuses_data">
                        @include('tender_user.tender_status.table')
    ...
    <script>
        $(document).ready(function() {
            $('#search').on('keyup', function() {
                var text = $('#search').val();
                url = "{{ route('tender-user.tender-statuses-search') }}"
    ...
    <script>
        $(document).on('change', '.toggle-class', function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('tender-user.changeTenderStatusStatus') }}',
                data: {
                    'status': status,
                    'id': id
                },
            ...
            $(document).on('click', '.edit-route', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var updateRoute =
                            "{{ route('tender-user.tender-statuses.update', ['tender_status' => ':id']) }}";
